...
disable_nextcloud_apps() {
  echo "5. IDA NetxCloud container: Disabling Nextcloud apps..."
...
enable_nextcloud_apps() {
  echo "6. IDA NextCloud container: Enabling Nextcloud apps..."
...
index_database() {
  echo "7. Database container: Indexing database..."
...
initialize_rabbitmq() {
  echo "8. Metadata & replication containers: Initializing rabbitmq and restarting containers..."
