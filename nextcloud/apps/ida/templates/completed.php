...
<meta name="fdwe-scope" content="ACTIONS / COMPLETED">
...
<div id="app" class="ida">
            ...
            <table class="idaTable">
                <?php if (sizeof($_['actions']) > 0) : ?>
                    <tr>
                        ...
                        <th class="ida-timestamp"><?php p($l->t('Completed')) ?></th>
                    ...
                    <?php foreach ($_['actions'] as $action): ?>
                        <tr>
                            ...
                            <td><?php p((new \DateTime($action->getCompleted()))->format('D, M j, Y, H:i') . ' UTC') ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td><?php p($l->t('No completed actions found.')) ?></td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
    ...
    <script nonce="<?php p(\OC::$server->getContentSecurityPolicyNonceManager()->getNonce()) ?>">
        document.title = "Completed Actions - IDA"; 
    </script>
</div>
