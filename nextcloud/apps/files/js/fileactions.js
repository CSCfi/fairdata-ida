            ...
            this.registerAction({
                ...
                actionHandler: function (filename, context) {
                    ...
                    if (context.$file.attr('data-mounttype') === 'shared-root') {
                        OC.Notification.show(t('ida', 'Root project folders may not be modified.'), {type: 'error'});
                        return;
                    }
                    var dir = context.dir || context.fileList.getCurrentDirectory();
                    ...
                    // END MODIFICATION
                    // IDA NOTE: we check for scope intersection of the new filename in the FileList.rename() function
