OC.L10N.register(
    ...
    "Your Nextcloud server is not backed by a Nextcloud Enterprise Subscription." : "O seu servidor Nextcloud non está protexido por unha Subscrición de Asistencia Empresarial do Nextcloud.",
    ...
    "If you need to stay longer on your current version without disruptions, you don't have to run software without security updates." : "Se quere permanecer algún tempo máis na súa actual versión sen interrupción, non ten que executar software sen actualizacións de seguridade. ",
    ...
    "This mail was sent to all administrators by the support app on your Nextcloud instance at %1$s because you have over %2$s registered users." : "Este correo foi enviado a todos os administradores pola aplicación de asistencia na súa instancia do Nextcloud en %1$s porque ten máis de %2$s usuarios rexistrados.",
    "Your Nextcloud server Subscription is over limit" : "A súa subscrición do servidor do Nextcloud está por riba do límite",
    ...
    "Your Nextcloud server Subscription is expired" : "A súa subscrición do servidor do Nextcloud caducou",
    "Your Nextcloud server Subscription is expired!" : "A súa subscrición do servidor do Nextcloud caducou!",
    ...
    "This mail was sent to all administrators by the support app on your Nextcloud instance at %s because your subscription expired." : "Este correo foi enviado a todos os administradores pola aplicación de asistencia na súa instancia do Nextcloud en %s porque a súa subscrición caducou.",
    "Support" : "Asistencia",
    ...
    "Subscription key:" : "Clave de subscrición:",
    ...
    "Update subscription key" : "Actualizar a clave de subscrición",
    ...
    "A Nextcloud Enterprise Subscription helps you get the most out of your Nextcloud, keep your data secure and your server working reliably at all times." : "Unha Subscrición de Asistencia Empresarial do Nextcloud axúdalle a obter o máximo rendemento do seu Nextcloud, conservar os seus datos seguros e a fiabilidade no funcionamento do seu servidor.",
    "Advantages" : "Vantaxes",
    ...
    "Subscription key" : "Clave de subscrición",
    "If you have an active Nextcloud Subscription please enter your subscription key here." : "Se vostede ten unha subscrición activa a Nextcloud, introduza aquí a súa clave de subscrición.",
    "Learn more about an enterprise subscription." : "Saiba máis sobre a subscrición empresarial.",
    "Set subscription key" : "Estabelecer a clave de subscrición",
    "The subscription info could not properly fetched right now. A retry is scheduled. Please check back later." : "Non foi posíbel obter correctamente a información da subscrición. Programouse outra tentativa. Compróbeo maís adiante.",
    "The subscription key was invalid." : "A clave de subscrición non é válida.",
    "The subscription key could not be verified, because this server has no internet connection. Please reach out to the support team to get this resolved." : "Non foi posíbel verificar a clave de subscrición porque este servidor non ten conexión a Internet. Póñase en contacto co equipo de asistencia para solucionar isto.",
    "The subscription key had an invalid format." : "A clave de subscrición ten un formato incorrecto.",
