OC.L10N.register(
    ...
    "A Nextcloud Enterprise Subscription means the original developers behind your self-hosted cloud server are 100% dedicated to your success: the security, scalability, performance and functionality of your service!" : "Nextcloud Enterprise Harpidetzak esan nahi du zure ostatatutako hodei zerbitzariaren atzean dauden jatorrizko garatzaileak % 100 zure arrakastara dedikatuta daudela: zure zerbitzuaren segurtasuna, eskalagarritasuna, errendimendua eta funtzionalitatea!",
    ...
    "GitHub" : "GitHub",
    "Nextcloud uses GitHub as platform to collaboratively work. You can file bug reports directly there." : "Nextcloudek GitHub erabiltzen du plataforma bezala kolaboratiboki lan egiteko. Akatsen txostenak zuzuenean bidali ditzakezu hara.",
    "Chat" : "Txata",
    "Chat with us on our IRC channel #nextcloud on Freenode." : "Hitz egin gurekin IRC kanalean #nextcloud Freenoden.",
