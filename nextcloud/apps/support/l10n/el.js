OC.L10N.register(
    ...
    "_%n month_::_%n months_" : ["%d μήνας","%d μήνες"],
    ...
    "Chat" : "Συνομιλία",
    "Chat with us on our IRC channel #nextcloud on Freenode." : "Μιλήστε μας στο κανάλι στο IRC #nextcloud στο Freenode.",
