OC.L10N.register(
    ...
    "Your Nextcloud server subscription does not cover your number of users." : "您所訂閱的 Nextcloud 服務無法涵蓋您的使用者數量。",
    ...
    "This mail was sent to all administrators by the support app on your Nextcloud instance at %1$s because you have over %2$s registered users." : "此郵件已由您在 %1$s 的 Nextcloud 站台透過支援應用程式傳送給所有管理員，因為您有超過 %2$s 個已註冊的使用者。",
    "Your Nextcloud server Subscription is over limit" : "您的 Nextcloud 伺服器訂閱已超出限制",
    "Dear admin," : "親愛的管理員，",
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact your Nextcloud account manager to get your subscription updated!" : "您的 Nextcloud 訂閱無法完全涵蓋目前在此伺服器上活躍的使用者數量。請聯絡您的 Nextcloud 客戶經理來更新您的訂閱！",
    ...
    "This mail was sent to all administrators by the support app on your Nextcloud instance at %s because you have more users than your subscription covers." : "此郵件已由您在 %s 的 Nextcloud 站台透過支援應用程式傳送給所有管理員，因為您有超過您訂閱所涵蓋的使用者數量。",
    ...
    "For an unlimited amount of users" : "對於無限數量的使用者",
    "_For %n active users_::_For %n active users_" : ["對於 %n 個活躍使用者"],
    "_For %n users_::_For %n users_" : ["對於 %n 個使用者"],
    "_currently at %n user_::_currently at %n users_" : ["目前有 %n 個使用者"],
    ...
    "Update subscription key" : "更新訂閱金鑰",
    ...
    "GitHub" : "GitHub",
    "Nextcloud uses GitHub as platform to collaboratively work. You can file bug reports directly there." : "Nextcloud 使用 GitHub 作為協作平台。您可以直接在那裡回報臭蟲。",
    "Chat" : "聊天",
    ...
    "Open chat" : "開啟聊天",
    "Subscription key" : "訂閱金鑰",
    "If you have an active Nextcloud Subscription please enter your subscription key here." : "如果您有作用中的 Nextcloud 訂閱，請在這裡輸入您的訂閱金鑰。",
    "Learn more about an enterprise subscription." : "了解關於企業訂閱的更多資訊。",
    "Set subscription key" : "設定訂閱金鑰",
    ...
    "The subscription key was invalid." : "訂閱金鑰無效。",
    "The subscription key could not be verified, because this server has no internet connection. Please reach out to the support team to get this resolved." : "無法驗證訂閱金鑰，因為此伺服器沒有網際網路連線。請與支援團隊以解決此問題。",
    "The subscription key had an invalid format." : "訂閱金鑰格式無效。",
    ...
    "News" : "新聞",
    "To get up to date information what is going on at Nextcloud sign up for the newsletter and follow us on our social media accounts." : "要取得最新資訊，請在 Nextcloud 上註冊並訂閱電子報，並在社群媒體上追蹤我們的社群媒體帳號。",
