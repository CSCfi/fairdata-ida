OC.L10N.register(
    ...
    "Could not share file \"%s\". Nevertheless, you can find it in the folder \"System information\"." : "无法共享文件 “%s”。 不过，您可以在 “系统信息” 文件夹中找到它。",
    ...
    "We can also provide Outlook integration, Online Office, scalable integrated audio-video and chat communication and other features only available in a limited form for free or develop further integrations and capabilities to your needs." : "我们还可以提供Outlook集成、在线办公、可扩展的集成音视频和聊天通信和其他功能，这些功能只能在有限的形式下免费提供，或者根据您的需求开发进一步的集成和功能。",
    ...
    "Dear admin," : "亲爱的管理员，",
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact your Nextcloud account manager to get your subscription updated!" : "您的 Nextcloud 订阅不能涵盖此服务器上当前活跃的用户数。请联系您的 Nextcloud 账号管理员更新您的订阅！",
    ...
    "Your Nextcloud server Subscription is expired!" : "您的Nextcloud服务器订阅已到期！",
    "Your Nextcloud Subscription has expired! Please contact your Nextcloud account manager to get your subscription updated!" : "您的 Nextcloud 订阅已到期！请联系您的 Nextcloud 账号管理员更新您的订阅！",
    ...
    "Extended maintenance life cycle" : "延长维护生命周期",
