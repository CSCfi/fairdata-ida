...
class TestIdaApp(unittest.TestCase):
    ...
    def test_ida_app(self):
        ...
        url = "%s/test_project_a+/testdata/2017-11/Experiment_6/test01.dat" % self.config["FILE_API"]
        headers = { "Destination": "%s/test_project_a/testdata/2017-11/Experiment_6/test01.dat" % self.config["FILE_API"] }
        ...
        url = "%s/test_project_a/testdata/2017-08/Experiment_2/test04.dat" % self.config["FILE_API"]
        ...
        url = "%s/test_project_d+/testdata/License.txt" % self.config["FILE_API"]
        ...
        url = "%s/test_project_d+/testdata/2017-10" % self.config["FILE_API"]
        response = requests.request(method='PROPFIND', url=url, auth=test_user_d, verify=False)
        self.assertEqual(response.status_code, 207)

        print("Attempt to upload new file contents with PUT request to WebDAV API when service is suspended")
        url = "%s/test_project_d+/testdata/newfile1.txt" % self.config["FILE_API"]
        data = { 'foo': 'bar' }
        ...
        url = "%s/test_project_d+/testdata/newfolder" % self.config["FILE_API"]
        ...
        url = "%s/test_project_d+/testdata/2017-10/Experiment_3/test01.dat" % self.config["FILE_API"]
        headers = { "Destination": "%s/test_project_d+/testdata/2017-10/Experiment_3/test01.dat2" % self.config["FILE_API"] }
        ...
        url = "%s/test_project_d+/testdata/2017-10/Experiment_3/test02.dat" % self.config["FILE_API"]
        headers = { "Destination": "%s/test_project_d+/testdata/2017-10/Experiment_3/test02.dat2" % self.config["FILE_API"] }
        ...
        url = "%s/test_project_d+/testdata/2017-10/Experiment_3/test03.dat" % self.config["FILE_API"]
        ...
        print(".", end='', flush=True)
        max_time = time.time() + self.timeout
        url = "%s/test_project_s+/testdata/License.txt" % self.config["FILE_API"]
        ...
        url = "%s/test_project_s+/testdata/2017-10" % self.config["FILE_API"]
        response = requests.request(method='PROPFIND', url=url, auth=test_user_s, verify=False)
        self.assertEqual(response.status_code, 207)

        print("Attempt to upload new file contents with PUT request to WebDAV API when project is suspended")
        url = "%s/test_project_s+/testdata/newfile1.txt" % self.config["FILE_API"]
        data = { 'foo': 'bar' }
        ...
        url = "%s/test_project_s+/testdata/newfolder" % self.config["FILE_API"]
        ...
        url = "%s/test_project_s+/testdata/2017-08/Experiment_1/test01.dat" % self.config["FILE_API"]
        headers = { "Destination": "%s/test_project_s+/testdata/2017-08/Experiment_1/test01.dat2" % self.config["FILE_API"] }
        response = requests.request(method='COPY', url=url, headers=headers, auth=test_user_s, verify=False)
        self.assertEqual(response.status_code, 409)
        self.assertIn('Project suspended. Action not permitted.', response.text)

        print("Attempt to duplicate file with COPY request to WebDAV API when project is suspended")
        url = "%s/test_project_s+/testdata/2017-08/Experiment_1/test02.dat" % self.config["FILE_API"]
        headers = { "Destination": "%s/test_project_s+/testdata/2017-08/Experiment_1/test02.dat2" % self.config["FILE_API"] }
        ...
        """
        headers = { 'ContentType': 'application/xml' }
        url = "%s/test_project_s+/testdata/2017-08/Experiment_1/test03.dat" % self.config["FILE_API"]
